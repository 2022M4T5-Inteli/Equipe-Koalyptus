...
float tempMax;         // Variável utilizada para configuração da temperatura máxima
float tempMin;         // Variável utilizada para configuração da temperatura mínima
float umidMax;         // Variável utilizada para configuração da umidade máxima
float umidMin;         // Variável utilizada para configuração da umidade mínima
